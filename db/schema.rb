...
ActiveRecord::Schema.define(version: 2020_10_06_075707) do
  ...
  create_table "pres", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["management_id"], name: "index_pres_on_management_id"
  end
  ...
  add_foreign_key "pres", "managements"
end
